...
새 프로젝트를 만들 때마다 이 표에 한 줄을 추가한다. 설명은 "무엇을 확인하려는가" 한 줄.

| 프로젝트 | 상태 | 설명 |
|---|---|---|
| [2026-09-jev/](2026-09-jev/) | 진행중 | TypeSafe AI의 "System One Model"(Jev) 조사 — 새로운 모델 클래스인지 constrained decoding 리브랜딩인지, LLM 분류/라우팅 호출 대체로 쓸 만한지 |
